...
public class EXCEL {
    ...
    public void executeBookRequest() throws IOException {
        // Load the Excel file
        FileInputStream file = new FileInputStream("C:\\Users\\swetha.yanala\\eclipse-workspace\\sw\\novRest_api\\expanded_data.xlsx"); // Update with your Excel file path
